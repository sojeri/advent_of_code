...
let { getRowDiff, getTotalDiff } = require('./02-1-solution')
...
describe('02-1-solution', () => {
    ...
    describe('getTotalDiff', () => {
        it('should return 18 for example input', () => {
            ...
            assert.equal(getTotalDiff(['5	1	9	5', '7	5	3', '2	4	6	8']), 18)
        })

        it('should return 18 for example input as file', () => {
            let result = runCallbackAgainstFile(getTotalDiff, '2017/02/02-1-example.txt')
