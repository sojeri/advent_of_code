...
let { reduceBoxId, generateChecksum } = require('./02-1-solution')
...
describe('02-1-solution', () => {
    ...
    describe('generateChecksum', () => {
        it('should return 12 for input matching above', () => {
            assert.equal(generateChecksum(['abcdef', 'bababc', 'abbcde', 'abcccd', 'aabcdd', 'abcdee', 'ababab']), 12)
        })
    })

    describe('generateChecksum against file', () => {
        it('should return 12 for input matching above', () => {
            let testFileChecksum = runCallbackAgainstFile(generateChecksum, '2018/02/02-1-testFile.txt')
