...
describe('05-1-solution', () => {
    describe('solution', () => {
        ...
        it('should return 10 for input dabAcCaCBAcCcaDA as a file', () => {
            let result = runCallbackAgainstFile(calculateCompoundSizeAfterReaction, '2018/05/05-1-example.txt')
            assert.equal(result, 10)
        })

        it('should return 9116 for puzzle input', () => {
            let result = runCallbackAgainstFile(calculateCompoundSizeAfterReaction, '2018/05/input.txt')
